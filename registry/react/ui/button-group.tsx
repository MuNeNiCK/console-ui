...
function ButtonGroupText({
  ...
  return (
    <Comp
      ...
      className={cn(
        "flex items-center gap-2 border border-border bg-card px-3 text-sm font-medium text-muted-foreground [&_svg]:pointer-events-none [&_svg:not([class*='size-'])]:size-4",
        className
      )}
      {...props}
    />
