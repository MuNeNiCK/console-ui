...
export const DropdownMenuSubTrigger = <T extends ValidComponent = "div">(
  ...
  return (
    <DropdownMenuPrimitive.SubTrigger
      ...
      class={cx(
        "flex h-8 cursor-default items-center gap-2 rounded-md px-2.5 text-sm outline-hidden select-none data-[highlighted]:bg-primary/10 data-[highlighted]:text-foreground data-[inset]:pl-8 data-[expanded]:bg-primary/10 data-[expanded]:text-foreground [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4 [&_svg:not([class*='text-'])]:text-muted-foreground",
        props.class,
      )}
      {...rest}
    >
...
export const DropdownMenuItem = <T extends ValidComponent = "div">(
  ...
  return (
    <DropdownMenuPrimitive.Item
      ...
      class={cx(
        "group/dropdown-menu-item relative flex h-8 cursor-default items-center gap-2 rounded-md px-2.5 text-sm outline-hidden select-none data-[highlighted]:bg-primary/10 data-[highlighted]:text-foreground data-[inset]:pl-8 data-[variant=destructive]:text-destructive data-[variant=destructive]:data-[highlighted]:bg-destructive/10 data-[variant=destructive]:data-[highlighted]:text-destructive dark:data-[variant=destructive]:data-[highlighted]:bg-destructive/20 data-[disabled]:pointer-events-none data-[disabled]:opacity-50 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4 [&_svg:not([class*='text-'])]:text-muted-foreground data-[variant=destructive]:*:[svg]:text-destructive!",
        props.class,
      )}
      {...rest}
    />
