...
export const ContextMenuSubTrigger = <T extends ValidComponent = "div">(
  ...
  return (
    <ContextMenuPrimitive.SubTrigger
      ...
      class={cx(
        "flex h-8 cursor-default items-center rounded-md px-2.5 text-sm outline-hidden select-none data-[highlighted]:bg-primary/10 data-[highlighted]:text-foreground data-[inset]:pl-8 data-[expanded]:bg-primary/10 data-[expanded]:text-foreground [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4 [&_svg:not([class*='text-'])]:text-muted-foreground",
        props.class,
      )}
      {...rest}
    >
...
export const ContextMenuItem = <T extends ValidComponent = "div">(
  ...
  return (
    <ContextMenuPrimitive.Item
      ...
      class={cx(
        "relative flex h-8 cursor-default items-center gap-2 rounded-md px-2.5 text-sm outline-hidden select-none data-[highlighted]:bg-primary/10 data-[highlighted]:text-foreground data-[inset]:pl-8 data-[variant=destructive]:text-destructive data-[variant=destructive]:data-[highlighted]:bg-destructive/10 data-[variant=destructive]:data-[highlighted]:text-destructive dark:data-[variant=destructive]:data-[highlighted]:bg-destructive/20 data-[disabled]:pointer-events-none data-[disabled]:opacity-50 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4 [&_svg:not([class*='text-'])]:text-muted-foreground data-[variant=destructive]:*:[svg]:text-destructive!",
        props.class,
      )}
      {...rest}
    />
...
export const ContextMenuCheckboxItem = <T extends ValidComponent = "div">(
  ...
  return (
    <ContextMenuPrimitive.CheckboxItem
      ...
      class={cx(
        "relative flex h-8 cursor-default items-center gap-2 rounded-md pr-2.5 pl-8 text-sm outline-hidden select-none data-[highlighted]:bg-primary/10 data-[highlighted]:text-foreground data-[disabled]:pointer-events-none data-[disabled]:opacity-50 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4",
        props.class,
      )}
      {...rest}
    >
...
export const ContextMenuRadioItem = <T extends ValidComponent = "div">(
  ...
  return (
    <ContextMenuPrimitive.RadioItem
      ...
      class={cx(
        "relative flex h-8 cursor-default items-center gap-2 rounded-md py-1.5 pr-2.5 pl-8 text-sm outline-hidden select-none data-[highlighted]:bg-primary/10 data-[highlighted]:text-foreground data-[disabled]:pointer-events-none data-[disabled]:opacity-50 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4",
        props.class,
      )}
      {...rest}
    >
...
export const ContextMenuLabel = ContextMenuGroupLabel
