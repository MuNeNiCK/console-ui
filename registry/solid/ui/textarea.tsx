...
export const TextFieldTextArea = <T extends ValidComponent = "textarea">(
  ...
  return (
    <TextFieldPrimitive.TextArea
      ...
      class={cx(
        "flex field-sizing-content min-h-20 w-full rounded-md border border-border bg-card px-3 py-2 text-base transition-[border-color,box-shadow] outline-none placeholder:text-muted-foreground hover:border-input focus-visible:border-ring focus-visible:ring-[3px] focus-visible:ring-ring/35 disabled:cursor-not-allowed disabled:opacity-50 aria-invalid:border-destructive aria-invalid:ring-destructive/20 md:text-sm dark:bg-input/30 dark:aria-invalid:ring-destructive/40",
        props.class,
      )}
      {...rest}
    />
...
export const Textarea = (props: TextareaProps) => {
  const [, rest] = splitProps(props as TextareaProps, ["class"])
