...
export function DataTable01() {
  ...
  return (
    <section className="grid min-h-0 grid-rows-[auto_48px_minmax(0,1fr)] bg-background text-foreground">
      ...
      <div className="flex items-center justify-end gap-2 border-b">
