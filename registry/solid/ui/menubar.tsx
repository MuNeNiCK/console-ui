...
export const MenubarTrigger = <T extends ValidComponent = "button">(
  ...
  return (
    <MenubarPrimitive.Trigger
      ...
      class={cx(
        "flex h-7 items-center rounded-md px-2.5 text-sm font-medium outline-hidden select-none focus:bg-primary/10 focus:text-foreground data-[expanded]:bg-primary/10 data-[expanded]:text-foreground",
        props.class,
      )}
      {...rest}
    />
...
export const MenubarContent = <T extends ValidComponent = "div">(
  ...
  return (
    <MenubarPrimitive.Content
      ...
      class={cx(
        "z-50 min-w-[12rem] origin-(--kb-menu-content-transform-origin) overflow-hidden rounded-md border bg-popover p-1 text-popover-foreground shadow-md focus-visible:outline-none data-[expanded]:animate-in data-[expanded]:fade-in-0 data-[expanded]:zoom-in-95 data-[closed]:animate-out data-[closed]:fade-out-0 data-[closed]:zoom-out-95",
...
export const MenubarItem = <T extends ValidComponent = "div">(
  ...
  return (
    <MenubarPrimitive.Item
      ...
      class={cx(
        "relative flex h-8 cursor-default items-center gap-2 rounded-md px-2.5 text-sm outline-hidden select-none focus:bg-primary/10 focus:text-foreground data-[disabled]:pointer-events-none data-[disabled]:opacity-50 data-[inset]:pl-8 data-[variant=destructive]:text-destructive data-[variant=destructive]:focus:bg-destructive/10 data-[variant=destructive]:focus:text-destructive dark:data-[variant=destructive]:focus:bg-destructive/20 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4 [&_svg:not([class*='text-'])]:text-muted-foreground data-[variant=destructive]:*:[svg]:text-destructive!",
        props.class,
      )}
      {...rest}
    />
...
export const MenubarCheckboxItem = <T extends ValidComponent = "div">(
  ...
  return (
    <MenubarPrimitive.CheckboxItem
      ...
      class={cx(
        "relative flex h-8 cursor-default items-center gap-2 rounded-md pr-2.5 pl-8 text-sm outline-hidden select-none focus:bg-primary/10 focus:text-foreground data-[disabled]:pointer-events-none data-[disabled]:opacity-50 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4",
        props.class,
      )}
      {...rest}
    >
...
export const MenubarRadioItem = <T extends ValidComponent = "div">(
  ...
  return (
    <MenubarPrimitive.RadioItem
      ...
      class={cx(
        "relative flex h-8 cursor-default items-center gap-2 rounded-md py-1.5 pr-2.5 pl-8 text-sm outline-hidden select-none focus:bg-primary/10 focus:text-foreground data-[disabled]:pointer-events-none data-[disabled]:opacity-50 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4",
        props.class,
      )}
      {...rest}
    >
...
export const MenubarSubTrigger = <T extends ValidComponent = "div">(
  ...
  return (
    <MenubarPrimitive.SubTrigger
      ...
      data-inset={props.inset}
      class={cx(
        "flex h-8 cursor-default items-center rounded-md px-2.5 text-sm outline-none select-none focus:bg-primary/10 focus:text-foreground data-[expanded]:bg-primary/10 data-[expanded]:text-foreground data-[inset]:pl-8 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4 [&_svg:not([class*='text-'])]:text-muted-foreground",
        props.class,
      )}
      {...rest}
    >
...
export const MenubarSubContent = <T extends ValidComponent = "div">(
  ...
  return (
    <MenubarPrimitive.SubContent
      ...
      class={cx(
        "z-50 min-w-[8rem] origin-(--kb-menu-content-transform-origin) overflow-hidden rounded-md border bg-popover p-1 text-popover-foreground shadow-lg focus-visible:outline-none data-[expanded]:animate-in data-[expanded]:fade-in-0 data-[expanded]:zoom-in-95 data-[closed]:animate-out data-[closed]:fade-out-0 data-[closed]:zoom-out-95",
