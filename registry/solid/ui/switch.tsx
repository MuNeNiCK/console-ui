...
export const Switch = <T extends ValidComponent = "div">(
  ...
  const [, rest] = splitProps(props as SwitchProps, [
    "class",
    "children",
    "size",
  ])
  ...
  return (
    <SwitchPrimitive
      ...
      class={cx(
        "inline-flex shrink-0 items-center leading-none data-[size=default]:h-5 data-[size=sm]:h-4",
      )}
      {...rest}
    >
      {(state) => (
...
export const SwitchControl = <T extends ValidComponent = "div">(
  ...
  return (
    <SwitchPrimitive.Control
      data-slot="switch-control"
      class={cx(
        "peer group/switch inline-flex h-5 w-9 shrink-0 items-center rounded-full border border-border bg-border/70 transition-[background-color,border-color,box-shadow] outline-none data-[checked]:border-primary data-[checked]:bg-primary data-[unchecked]:hover:border-input dark:data-[unchecked]:bg-input/80",
        "peer-focus-visible/switch-input:border-ring peer-focus-visible/switch-input:ring-ring/35 peer-focus-visible/switch-input:ring-[3px]",
...
export const SwitchThumb = <T extends ValidComponent = "div">(
  ...
  return (
    <SwitchPrimitive.Thumb
      data-slot="switch-thumb"
      class={cx(
        "pointer-events-none block size-4 rounded-full bg-card ring-0 shadow-[0_1px_2px_rgb(0_0_0/0.18)] transition-transform data-[checked]:translate-x-[calc(100%-1px)] data-[unchecked]:translate-x-0 dark:data-[checked]:bg-primary-foreground dark:data-[unchecked]:bg-foreground",
        props.class,
      )}
      {...rest}
    />
