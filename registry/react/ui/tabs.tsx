  ...
  return (
    <TabsPrimitive.Tab
      ...
      className={cn(
        ...
        "group-data-[orientation=horizontal]/tabs:-mb-px group-data-[orientation=horizontal]/tabs:h-10 group-data-[orientation=horizontal]/tabs:border-b-2 group-data-[orientation=horizontal]/tabs:data-active:border-primary group-data-horizontal/tabs:-mb-px group-data-horizontal/tabs:h-10 group-data-horizontal/tabs:border-b-2 group-data-horizontal/tabs:data-active:border-primary",
        "group-data-[orientation=vertical]/tabs:w-full group-data-[orientation=vertical]/tabs:justify-start group-data-[orientation=vertical]/tabs:border-r-2 group-data-[orientation=vertical]/tabs:border-b-0 group-data-[orientation=vertical]/tabs:px-3 group-data-[orientation=vertical]/tabs:py-2 group-data-[orientation=vertical]/tabs:data-active:border-primary group-data-vertical/tabs:w-full group-data-vertical/tabs:justify-start group-data-vertical/tabs:border-r-2 group-data-vertical/tabs:border-b-0 group-data-vertical/tabs:px-3 group-data-vertical/tabs:py-2 group-data-vertical/tabs:data-active:border-primary",
